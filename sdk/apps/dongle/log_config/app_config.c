...
const char log_tag_const_v_BTSTACK AT(.LOG_TAG_CONST)  = 0;
const char log_tag_const_i_BTSTACK AT(.LOG_TAG_CONST)  = 1;
const char log_tag_const_d_BTSTACK AT(.LOG_TAG_CONST)  = 1;
const char log_tag_const_w_BTSTACK AT(.LOG_TAG_CONST)  = 1;
const char log_tag_const_e_BTSTACK AT(.LOG_TAG_CONST)  = 1;
...
const char log_tag_const_d_APP_PC AT(.LOG_TAG_CONST) = FALSE;
