...
//                                 USB 配置                                        //
//*********************************************************************************//
#define TCFG_PC_ENABLE                      1//TCFG_APP_PC_EN//PC模块使能
#define TCFG_UDISK_ENABLE					DISABLE_THIS_MOUDLE//U盘模块使能
#define TCFG_OTG_USB_DEV_EN                 0//BIT(0)//USB0 = BIT(0)  USB1 = BIT(1)
...
#define TCFG_AUDIO_ENABLE				0//	DISABLE


#if TCFG_APP_PC_EN
#undef TCFG_AUDIO_ENABLE
