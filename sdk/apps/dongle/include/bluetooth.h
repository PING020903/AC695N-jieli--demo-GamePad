...
int hci_send_acl_packet(const u8 *packet, uint16_t size);

// HCI Commands - see hci_cmds.c for info on parameters
extern const hci_cmd_t hci_accept_sco_connection_request;
extern const hci_cmd_t hci_reject_sco_connection_request;
...
extern const hci_cmd_t hci_flow_control_enable;
extern const hci_cmd_t hci_host_buffer_size;
extern const hci_cmd_t hci_host_num_of_completed;
...
extern const hci_cmd_t hci_setup_sco_connection;
...
extern const hci_cmd_t hci_read_voice_setting;
...
extern const hci_cmd_t hci_write_afh_channel_assessment_mode ;
...
extern const hci_cmd_t HCI_Write_Page_Scan_Period_Mode;
extern const hci_cmd_t hci_write_page_scan_mode;
extern const hci_cmd_t hci_write_local_name;
extern const hci_cmd_t hci_read_local_name;
extern const hci_cmd_t hci_read_connection_accept_timeout;
...
extern const hci_cmd_t hci_send_keypress_notification;

extern  const hci_cmd_t hci_set_connectionless_slave_broadcast ;
extern  const hci_cmd_t hci_set_connectionless_slave_broadcast_receive ;
extern  const hci_cmd_t hci_start_synchronization_train ;
extern  const hci_cmd_t hci_receive_synchronization_train;
