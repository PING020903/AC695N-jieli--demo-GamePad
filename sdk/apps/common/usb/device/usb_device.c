...
void uac_my_pc360_0(const usb_dev usb_id, u8 *ptr, u32 *cur_itf_num);
void uac_my_pc360_1(const usb_dev usb_id, u8 *ptr, u32 *cur_itf_num);
void uac_my_pc360_2(const usb_dev usb_id, u8 *ptr, u32 *cur_itf_num);
void uac_my_pc360_3(const usb_dev usb_id, u8 *ptr, u32 *cur_itf_num);
/**********************/
...
#if ENABLE
    log_info("add desc my xbox360");
    xbox360_register(usb_id);//缓冲区预处理

    usb_add_desc_config(usb_id, class_index++, uac_my_pc360_0);
